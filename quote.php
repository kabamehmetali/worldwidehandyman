...
$canonicalPath   = 'quote';
$ogImage         = 'assets/img/quote-hero-v2.png';
...
<section class="page-banner page-banner-portrait quote-banner" style="background-image: url('<?= esc(base_url('assets/img/quote-hero-v2.png')) ?>');">
    <div class="container">
